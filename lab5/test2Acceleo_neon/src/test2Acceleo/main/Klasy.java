...
/**
 * Entry point of the 'Klasy' generation module.
 *
 * @generated
 */
public class Klasy extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/test2Acceleo/main/klasy";
     ...
     * @generated
     */
    public Klasy(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Klasy(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Klasy generator = new Klasy(modelURI, folder, arguments);
