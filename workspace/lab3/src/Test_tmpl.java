...
public class Test_tmpl {
    public static void main(String[] args) throws Exception {
				// Ładujemy szablony
				FileReader groupFile = new FileReader("src/pierwszy.stg");
        ...
        try {
          ...
          // Wywołujemy parser drzew - startując od reguły prog (Tym razem z klasy TExpr3!)
          TExpr3.prog_return tpl = walker.prog();
